...
public class ConnectionProxy extends WrapperProxy implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        return connector.post(format("%s/statement", entityUrl), null, StatementProxy.class);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return connector.post(format("%s/prepared-statement", entityUrl), sql, PreparedStatementProxy.class);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return connector.post(format("%s/prepared-statement?type=%d&concurrency=%d", entityUrl, resultSetType, resultSetConcurrency), sql, PreparedStatementProxy.class);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return connector.post(format("%s/statement?type=%d&concurrency=%d&holdability=%d", entityUrl, resultSetType, resultSetConcurrency, resultSetHoldability), null, StatementProxy.class);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return connector.post(format("%s/prepared-statement?type=%d&concurrency=%d&holdability=%d", entityUrl, resultSetType, resultSetConcurrency, resultSetHoldability), sql, PreparedStatementProxy.class);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return connector.post(format("%s/prepared-statement?keys=%d", entityUrl, autoGeneratedKeys), sql, PreparedStatementProxy.class);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        String indices = Arrays.stream(columnIndexes).mapToObj(i -> "" + i).collect(Collectors.joining(","));
        return connector.post(format("%s/prepared-statement?indexes=%s", entityUrl, indices), sql, PreparedStatementProxy.class);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        String names = Arrays.stream(columnNames).map(n -> "" + encode(n)).collect(Collectors.joining(","));
        return connector.post(format("%s/prepared-statement?names=%s", entityUrl, names), sql, PreparedStatementProxy.class);
    }
